...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Build a sales system your team runs without you" },
      ...
      { property: "og:title", content: "Build a sales system your team runs without you" },
      { name: "twitter:title", content: "Build a sales system your team runs without you" },
