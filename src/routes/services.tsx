...
export const Route = createFileRoute("/services")({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Three offerings, nine tiers. Diagnostic, System Building and Fractional CRO Leadership with fixed prices, fixed timelines, outcome-linked payments." },
      { property: "og:title", content: "Services Vonerio" },
      { property: "og:description", content: "Diagnostic, System Building and Fractional CRO Leadership sized to your team." },
    ...
    <>
      <section className="container-page py-16 md:py-24">
        <Reveal>
          ...
          <h1 className="text-hero mt-6 max-w-4xl">Offerings sized to your team.</h1>
      ...
      <div className="bg-[var(--color-mist)] dark:bg-[var(--color-indigo)]/30">
        <ServiceSection
          ...
          intro="Co-built live in build sprints. Playbook, scripts, objection handling, battle cards, cadences. Final payment is tied to a real adoption signal."
          cards={[
...
const FAQS = [
  ...
  { q: "Who is this for?", a: "Companies with $5M–$100M in revenue selling complex B2B SaaS/observability, ServiceNow, consulting & managed services, cloud transformation, data & AI where deals involve multiple stakeholders and long cycles." },
];
